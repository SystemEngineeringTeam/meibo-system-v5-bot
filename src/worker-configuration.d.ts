/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings ./src/worker-configuration.d.ts` (hash: 91dafa82d6dbcdc277bed563339dd86e)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		APPROVAL_REQUEST_KV: KVNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_BOT_TOKEN" | "SLACK_SIGNING_SECRET" | "SLACK_LOGGING_LEVEL" | "AUTH0_DOMAIN" | "AUTH0_CLIENT_ID" | "AUTH0_CLIENT_SECRET" | "AUTH0_SESSION_SECRET" | "SLACK_BOT_BASE_URL" | "SLACK_BOT_TEAM_ID" | "SLACK_BOT_APP_ID" | "NOTIFY_CHANNEL_ID">> {}
}
