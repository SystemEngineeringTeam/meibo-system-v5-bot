/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings ./src/worker-configuration.d.ts` (hash: 57624a624d5fb930672a6e09f4eee2c2)
// Runtime types generated with workerd@1.20260526.1 2025-09-27 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	LINK_KV?: KVNamespace;
	CHANNEL_KV?: KVNamespace;
	USER_KV?: KVNamespace;
	PAYEE_KV?: KVNamespace;
	SETTINGS_KV?: KVNamespace;
	ACCESS_TOKEN_KV?: KVNamespace;
	REFRESH_TOKEN_KV?: KVNamespace;
	AFTER_INPUT_MEMBER_INFO_QUE?: Queue;
	RETRIEVE_FLAGGED_MEMBERS_QUE?: Queue;
	...
	SLACK_BOT_TEAM_ID: string;
	SLACK_BOT_APP_ID: string;
	SPREAD_SHEET_API_URL: string;
	API_BASE_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_BOT_TOKEN" | "SLACK_SIGNING_SECRET" | "SLACK_LOGGING_LEVEL" | "AUTH0_DOMAIN" | "AUTH0_CLIENT_ID" | "AUTH0_CLIENT_SECRET" | "AUTH0_SESSION_SECRET" | "AUTH0_AUDIENCE" | "SLACK_BOT_BASE_URL" | "SLACK_BOT_TEAM_ID" | "SLACK_BOT_APP_ID" | "SPREAD_SHEET_API_URL" | "API_BASE_URL">> {}
}
