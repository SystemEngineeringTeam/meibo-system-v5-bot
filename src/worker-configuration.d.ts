/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings ./src/worker-configuration.d.ts` (hash: 554f99ef14a2b898634cbc6cebf4e1ab)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_BOT_TOKEN" | "SLACK_SIGNING_SECRET" | "SLACK_LOGGING_LEVEL" | "AUTH0_DOMAIN" | "AUTH0_CLIENT_ID" | "AUTH0_CLIENT_SECRET" | "AUTH0_SESSION_SECRET" | "SLACK_BOT_BASE_URL" | "SLACK_BOT_TEAM_ID" | "SLACK_BOT_APP_ID" | "SPREAD_SHEET_API_URL">> {}
}
